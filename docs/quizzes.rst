...
There will be four Canvas based quizzes throughout the semester.

Timing
------

1) Week 3 -- first quiz (covering all material from weeks 1 and 2)

2) Week 5 -- second quiz (covering all material from weeks 3 and 4)

3) Week 9 -- third quiz (covering all material from weeks 5, 6, 7, and 8)

4) Week 12 -- fourth quiz (covering all material from weeks 9, 10, and 11)
...
* If you miss a quiz with an approved reason (for example, due to documented sickness) the final exam
  will be scaled up commensurately. (That is, the final exam will effectively make up for the missed
  quiz.)
